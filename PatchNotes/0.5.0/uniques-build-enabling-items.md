# PoE2 0.5.0 Uniques and Build-Enabling Items

Source: [Content Update 0.5.0 captured patch notes](../poe2-0.5.0-return-of-the-ancients.md)

## New Unique Item Pool

- The patch adds a large set of new uniques, including Berek's Grip, Berek's Pass, Berek's Respite, Brutus' Lead Sprinkler, Cat O' Nine Tails, Facebreaker, Loreweave, Mageblood, Split Personality, Voices, and many more. [L313-L354](../poe2-0.5.0-return-of-the-ancients.md#L313-L354)
- Rise of the Phoenix received 3D art. [L363](../poe2-0.5.0-return-of-the-ancients.md#L363)
- The important knowledge-base implication is that several PoE1-defining names enter PoE2's item pool, so build archetypes around unarmed scaling, flask power, jewel sockets, and resistance/item-stat conversion may need fresh PoE2-specific notes.
...
## Defensive and Resource Build Items

- Ab Aeterno loses its old dodge-roll speed penalty scaling and gains much higher Armour, Evasion, and Energy Shield plus slow immunity while sprinting and Overencumbrance on dodge roll. [L559](../poe2-0.5.0-return-of-the-ancients.md#L559)
- Apep's Supremacy loses faster Energy Shield recharge start. [L560](../poe2-0.5.0-return-of-the-ancients.md#L560)
- Atziri's Acuity is reworked around Armour, maximum Life, Physical Attack Damage leeched as Life, Blood Loss, Vaal Pact, and Herald of the Royal Queen. [L561](../poe2-0.5.0-return-of-the-ancients.md#L561)
- Sierran Inheritance now gives Energy Shield Recharge Rate rather than faster recharge start. [L562](../poe2-0.5.0-return-of-the-ancients.md#L562)
...
## Damage and Archetype-Defining Items

- Blackflame is reworked into Withered increasing Fire damage taken, chaos-damage Ignites, non-expiring Withered on ignited enemies, and stronger Ignite magnitude with shorter duration. [L563](../poe2-0.5.0-return-of-the-ancients.md#L563)
- Blistering Bond now enables Fire Damage to contribute to Bleeding Magnitude and makes Bleeding deal Fire damage. [L564](../poe2-0.5.0-return-of-the-ancients.md#L564)
- Carnage Heart now gives increased damage while leeching. [L566](../poe2-0.5.0-return-of-the-ancients.md#L566)
- Death's Harp trades flat additional arrows for high Surpassing chance to fire an additional arrow. [L568](../poe2-0.5.0-return-of-the-ancients.md#L568)
...
- Seed of Cataclysm changes from flat Critical Spell Damage Bonus to reduced bonus per recent spell crit plus Lucky spell critical damage chance. [L583](../poe2-0.5.0-return-of-the-ancients.md#L583)

## Skill, Minion, Totem, and Flask Items
...
- The biggest build-watch items are Facebreaker, Mageblood, Loreweave, Voices, Split Personality, Svalinn, Atziri's Acuity, Blackflame, Death's Harp, Collapsing Horizon, Unborn Lich, and the renamed resistance-scaling Sekhema rings.
- Several changed uniques now lean harder into PoE2 mechanics: Runic Ward, Blood Loss, Presence, Remnants, Spirit, Surpassing chance, and flask/Charm charge loops.
- Existing-item notes matter: some changes are divinable or affect existing items, while others explicitly do not. Each item page should track this separately.
