...
## 3. HIGH LIQUIDITY TARGETS (THE "CASH" LIST)

| Item | Liquidity Tier | Best Time to Sell | Value Trend |
| :--- | :--- | :--- | :--- |
...
## 4. EXPERT PROFIT METRICS (DIV/HR)
Target these metrics to ensure you are staying ahead of the "wealth curve" in v0.4+:
- **Day 1**: 1 Div/hr (Progression/completion focus).
- **Day 3**: 3-5 Div/hr (Basic T15 loop).
- **Week 1**: 8-10 Div/hr (3-slot juicing).
- **Week 4**: 20-30+ Div/hr (Elite Citadel/Simulacrum/Depth rotations).
